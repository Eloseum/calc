...
# ----------------------------------------
# If TestClock is one of several IP cores in your
...
# ----------------------------------------
# ACDS 18.0 614 win32 2019.03.05.22:05:07
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/TestClock.vho"
}
