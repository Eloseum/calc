...
add wave -noupdate -expand -group HX8357_Controller /tb_top/uut/IC_3/CLOCK
add wave -noupdate -expand -group HX8357_Controller /tb_top/uut/IC_3/RESET
add wave -noupdate -expand -group HX8357_Controller /tb_top/uut/IC_3/MCU_IORQ
add wave -noupdate -expand -group HX8357_Controller /tb_top/uut/IC_3/MCU_WR
add wave -noupdate -expand -group HX8357_Controller /tb_top/uut/IC_3/MCU_RD
add wave -noupdate -expand -group HX8357_Controller -radix hexadecimal /tb_top/uut/IC_3/MCU_DAT
add wave -noupdate -expand -group HX8357_Controller -radix hexadecimal /tb_top/uut/IC_3/MCU_ADD
add wave -noupdate -expand -group HX8357_Controller /tb_top/uut/IC_3/MCU_INT
add wave -noupdate -expand -group HX8357_Controller /tb_top/uut/IC_3/MCU_BUSRQ
add wave -noupdate -expand -group HX8357_Controller /tb_top/uut/IC_3/LCD_RST
add wave -noupdate -expand -group HX8357_Controller /tb_top/uut/IC_3/LCD_CS
add wave -noupdate -expand -group HX8357_Controller /tb_top/uut/IC_3/LCD_DCX
add wave -noupdate -expand -group HX8357_Controller /tb_top/uut/IC_3/LCD_WR
add wave -noupdate -expand -group HX8357_Controller /tb_top/uut/IC_3/LCD_RD
add wave -noupdate -expand -group HX8357_Controller -radix hexadecimal /tb_top/uut/IC_3/LCD_DAT
add wave -noupdate -expand -group HX8357_Controller -radix hexadecimal /tb_top/uut/IC_3/LEDR
add wave -noupdate -expand -group HX8357_Controller -radix hexadecimal /tb_top/uut/IC_3/SW
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {263765149 ps} 0}
...
update
WaveRestoreZoom {245668316 ps} {350668316 ps}
