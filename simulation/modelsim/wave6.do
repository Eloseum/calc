...
add wave -noupdate -expand -group Processor -height 18 -expand -group External -radix hexadecimal /tb_top/uut/SW
add wave -noupdate -expand -group Processor -height 18 -expand -group External -radix hexadecimal /tb_top/uut/KEY
add wave -noupdate -expand -group Processor -height 18 -expand -group External /tb_top/uut/HEX0
add wave -noupdate -expand -group Processor -height 18 -expand -group External /tb_top/uut/HEX1
add wave -noupdate -expand -group Processor -height 18 -expand -group External /tb_top/uut/HEX2
add wave -noupdate -expand -group Processor -height 18 -expand -group External /tb_top/uut/HEX3
add wave -noupdate -expand -group Processor -height 18 -expand -group External /tb_top/uut/HEX4
add wave -noupdate -expand -group Processor -height 18 -expand -group External /tb_top/uut/HEX5
add wave -noupdate -expand -group Processor -height 18 -expand -group External -radix hexadecimal /tb_top/uut/SW
add wave -noupdate -expand -group Processor -height 18 -expand -group External -radix hexadecimal /tb_top/uut/KEY
add wave -noupdate -expand -group Processor -height 18 -expand -group External /tb_top/uut/IC_3/INT
add wave -noupdate -expand -group Processor -height 18 -expand -group External -radix hexadecimal /tb_top/uut/HEX0
add wave -noupdate -expand -group Processor -height 18 -expand -group External -radix hexadecimal /tb_top/uut/HEX1
add wave -noupdate -expand -group Processor -height 18 -expand -group External -radix hexadecimal /tb_top/uut/HEX2
add wave -noupdate -expand -group Processor -height 18 -expand -group External -radix hexadecimal /tb_top/uut/HEX3
add wave -noupdate -expand -group Processor -height 18 -expand -group External -radix hexadecimal /tb_top/uut/HEX4
add wave -noupdate -expand -group Processor -height 18 -expand -group External -radix hexadecimal /tb_top/uut/HEX5
...
add wave -noupdate -expand -group Memory /tb_top/uut/IC_1/wren
add wave -noupdate -expand -group Memory -radix hexadecimal /tb_top/uut/IC_1/q
add wave -noupdate -expand -group MemoryController /tb_top/uut/IC_2/WR
add wave -noupdate -expand -group MemoryController /tb_top/uut/IC_2/RD
add wave -noupdate -expand -group MemoryController /tb_top/uut/IC_2/MREQ
add wave -noupdate -expand -group MemoryController -radix hexadecimal /tb_top/uut/IC_2/Q
add wave -noupdate -expand -group MemoryController -radix hexadecimal /tb_top/uut/IC_2/DATA
add wave -noupdate -expand -group MemoryController -radix hexadecimal /tb_top/uut/IC_2/IO_8
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {38567663 ps} 0}
