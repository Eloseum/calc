...
add wave -noupdate -expand -group External /tb_top/uut/IC_3/INT
add wave -noupdate -expand -group External -radix hexadecimal /tb_top/uut/HEX0
add wave -noupdate -expand -group External -radix hexadecimal /tb_top/uut/HEX1
add wave -noupdate -expand -group External -radix hexadecimal /tb_top/uut/HEX2
add wave -noupdate -expand -group External -radix hexadecimal /tb_top/uut/HEX3
add wave -noupdate -expand -group External -radix hexadecimal /tb_top/uut/HEX4
add wave -noupdate -expand -group External -radix hexadecimal /tb_top/uut/HEX5
...
WaveRestoreCursors {{Cursor 1} {151284623 ps} 0}
...
update
WaveRestoreZoom {144556811 ps} {210181811 ps}
